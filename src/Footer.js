...
const Footer = () => {
  return (
    <div className="section bg-black wf-section" style={{backgroundColor:"black"}}>
      <div className="container">
        <div className="footer-grid">
          ...
          >
             <img
              src={software} width="90px"
              loading="lazy"
              alt="Logo"
              className="footer-gum-icon"
            />
           
            <div className="text-small" style={{color:"white"}}>Ⓒ logo</div>
          </div>
          <div
